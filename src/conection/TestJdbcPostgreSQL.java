...
public class TestJdbcPostgreSQL {
	...
	public static void main(String[] argv) {
		...
		System.out.println("Prova de connexi� a PostgreSQL amb JDBC");
		try {
			Class.forName("org.postgresql.Driver");
		} catch (ClassNotFoundException e) {
			System.out.println("El driver de JDBC no est� al Classpath!");
			e.printStackTrace();
			return;
		}
		...
		try {			
			...
			System.out.println("Error de connexi�");
			e.printStackTrace();
			return; 
		}
		if (connection != null) {
			...
			System.out.println("La connexi� ha fallat!");
		}
	}
}
